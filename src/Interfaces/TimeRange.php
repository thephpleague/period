...
/**
 * TimeRange defines a barebone interface for interacting with time range
 *
 * @package league.period
 * @since   2.5.0
 */
interface TimeRange
{
    ...
    /**
     * Returns the TimeRange duration as a DateInterval object.
     *
    ...
    /**
     * String representation of a TimeRange using ISO8601 Time interval format
     *
     * @return string
     */
