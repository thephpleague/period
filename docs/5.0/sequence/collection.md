...
$sequence->get(42); //throws a League\Period\DateRangeInaccessible exception
$sequence[3]->format('Y-m-d');  //returns [2018-01-20, 2018-03-10)
$sequence[42]; //throws a League\Period\DateRangeInaccessible exception
...
$sequence->remove(42);//throws DateRangeInaccessible
unset($sequence[2]);
unset($sequence[42]);//throws DateRangeInaccessible
unset($sequence[-2]);
unset($sequence[-25]);//throws DateRangeInaccessible
~~~
