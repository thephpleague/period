...
final class SequenceTest extends TestCase
{
    ...
    public function testDiff1(): void
    {
        $sequence = new Sequence(
            ...
            new Period('2018-01-15', '2018-03-01'),
            new Period('2017-12-01', '2018-01-02')
        );
        $interval = new Period('2018-01-01', '2018-02-01');
        $diff = $sequence->diff($interval);
        self::assertCount(2, $diff);
        self::assertTrue($diff->get(0)->equals(new Period('2018-01-02', '2018-01-05')));
        self::assertTrue($diff->get(1)->equals(new Period('2018-01-10', '2018-01-15')));
    }

    public function testDiff2ReturnsEmptySequenceWhenNoPeriodOverlaps(): void
    {
        $sequence = new Sequence(
            new Period('2018-01-05', '2018-01-10'),
            new Period('2018-01-15', '2018-03-01'),
        ...
        $interval = new Period('2019-01-01', '2019-02-01');
        self::assertTrue($sequence->diff($interval)->isEmpty());
    }
    ...
    public function testDiff3(): void
    {
        ...
        self::assertTrue($diff->get(0)->equals(new Period('2018-01-01', '2018-01-05')));
        self::assertTrue($diff->get(1)->equals(new Period('2018-01-10', '2018-01-15')));
        self::assertTrue($diff->get(2)->equals(new Period('2018-01-20', '2018-02-01')));
    }
}
